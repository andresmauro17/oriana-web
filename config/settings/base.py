"""
Django settings for oriana project.
...
SECRET_KEY = '$nl!ts0fy5$4+1(pd+ll$nfksy!q1r*xj*sq_r8m%v4f%_z_pp'
...
MIDDLEWARE = [
    ...
    'app_users.middleware.organizationuser.VerifyUserHasOrganizationMiddleware'
]
...
DATABASES = {
    'default': {
        ...
        'OPTIONS': {
            ...
            'database' : os.getenv('ORIANA_DB_NAME'),
