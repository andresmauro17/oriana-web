    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_organization', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='app_organizations.organization')),
                ('current_site', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='app_organizations.site')),
